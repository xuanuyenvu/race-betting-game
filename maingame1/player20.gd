...
func _physics_process(delta):
	...
	velocity.x = speed*direction*roll_a_dice(1,4)
	move_and_slide(velocity)




func _on_check5_body_entered(body):
...
func _on_Timer_slow_5_timeout():
	speed = speed + slow_dow
	set_modulate(Color(1,1,1,1)) 


	
func _on_Timer_fast_5_timeout():
	speed = speed - speed_up
	set_modulate(Color(1,1,1,1)) 
...
func _on_check5_body_exited(body):
